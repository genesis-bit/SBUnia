...
@Component({
  selector: "app-documentos-situacao",
  templateUrl: "./documentos-situacao.component.html",
  styleUrls: ["./documentos-situacao.component.css"],
})
export class DocumentosSituacaoComponent {
  ...
  editDocumentByCode(code: string) {
    this.router.navigate(["gd/ver-documento-situacao/", code]);
