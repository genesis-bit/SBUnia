...
@Component({
  selector: 'app-actividade-tarefas',
  templateUrl: './actividade-tarefas.component.html',
  styleUrls: ['./actividade-tarefas.component.css']
})
export class ActividadeTarefasComponent {
