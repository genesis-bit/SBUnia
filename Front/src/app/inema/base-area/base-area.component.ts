...
import { Base_area } from "../model/base_area";
...
@Component({
  ...
  styleUrls: ['./base-area.component.css']
})
export class BaseAreaComponent {
  ...
  carregarLista() {
    ...
    this.generalService  .execute(`base-areas`,GeneralConstants.CRUD_OPERATIONS.READ,   "",   "",  params   )
      .subscribe((res: any) => {
        if (res.data) {
          console.log(res)
          this.base_areas = res.data.data;
  ...
  save() {
    if (this.momentForm.invalid) {
      console.log("Dados inválidos", this.base_area);
