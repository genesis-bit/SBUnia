...
import { Ocorrencia_atividade_tipo } from "../model/ocorrencia_atividade_tipo";
...
@Component({
  selector: "app-ocorrencias-atividades-tipo",
  templateUrl: "./ocorrencias-atividades-tipo.component.html",
  styleUrls: ["./ocorrencias-atividades-tipo.component.css"],
})
export class OcorrenciasAtividadesTipoComponent {
  ...
  tipo_documentos: any;
  ocorrencias_atividades_tipos: any;
  ocorrencia_atividade_tipo = new Ocorrencia_atividade_tipo();
  ...
  ngOnInit() {
    ...
    this.breadCrumbItems = [
      { label: "Roval" },
      { label: "Gerir Tipos de atividades ocorrências", active: true },
    ];
  ...
  carregarLista() {
    ...
    this.generalService
      ...
      .subscribe((res: any) => {
        if (res.data) {
          this.ocorrencias_atividades_tipos = res.data.data;
  ...
  save() {
    if (this.momentForm.invalid) {
      console.log("Dados inválidos", this.ocorrencia_atividade_tipo);
      console.log("ERROS", this.momentForm.errors);
      return;
    }
    console.log("DADOS válidos", this.ocorrencia_atividade_tipo);
    this.ocorrencia_atividade_tipo = new Ocorrencia_atividade_tipo();
