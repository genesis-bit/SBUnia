...
export const MENU: MenuItem[] = [
    {
        id: 140,
        label: 'MENUITEMS.BIBLIOTECA.TEXT',
        icon: 'bx-file',
        isCollapsed: false,
        subItems: [
            {
                id: 146,
                label: 'MENUITEMS.BIBLIOTECA.LIST.STARTER',
                link: '/home',
                parentId: 140
            },
            {
                id: 145,
                label: 'MENUITEMS.BIBLIOTECA.LIST.MAINTENANCE',
            ...
            {
                id: 143,
                label: 'MENUITEMS.BIBLIOTECA.LIST.TIMELINE',
